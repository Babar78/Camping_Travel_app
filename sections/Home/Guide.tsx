  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        ...
        <p className="uppercase regular-18 -mt-1 mb-3 text-green-50 text-center">
          We are here for you
        </p>
        <div className="space-y-5 lg:space-y-10 text-center">
          <h2 className="bold-40 lg:bold-64 ">Guide You to Easy Path</h2>
          <p className="regular-16 text-gray-30 ">
            Only with the TravelTrek application you will no longer get lost and
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              <div className="flexBetween w-full">
                ...
                <p className="bold-16 text-green-50">05 KM</p>
              </div>
            ...
            <div className="flex w-full flex-col">
              ...
              <h4 className="bold-20 mt-2 whitespace-nowrap">Raikot Bridge</h4>
            </div>
          </div>
        </div>
      </div>
