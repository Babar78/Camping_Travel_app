...
export const FEATURES = [
  {
    title: "Real Maps for Every Adventure",
    icon: "/map.svg",
    variant: "green",
    description:
      "We offer reliable, detailed maps to guide you on your journey, ensuring you always have the information you need, even in remote locations.",
  },
  {
    ...
    variant: "green",
    description:
      "Easily organize and schedule your next adventure with friends or family. Explore exciting travel packages and exclusive offers tailored to make your trip unforgettable.",
  },
  {
    title: "Explore with Augmented Reality",
    icon: "/tech.svg",
    variant: "green",
    description:
      "Experience your travels in a whole new way with augmented reality features that enhance your exploration, bringing landmarks and hidden gems to life right before your eyes.",
  },
  {
    ...
    variant: "orange",
    description:
      "Stay inspired with new destinations added every month. Our global network of travelers shares their favorite spots, ensuring there’s always a fresh adventure waiting for you.",
  },
];
...
export const FOOTER_LINKS = [
  ...
  {
    title: "Explore",
    links: ["Mountain Climbing", "Hiking Adventures", "Trek with TravelTrek"],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: "Email Officer", value: "contact@traveltrek.com" },
  ],
};
